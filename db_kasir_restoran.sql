...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2020 at 05:14 AM
...
('555', 'Es Telor', 'Minuman', 4500),
('ES6', 'Es Kecap Bango', 'Minuman', 5000),
('M1', 'Nasi Goreng', 'Makanan', 15000),
('M3', 'Teh Jus', 'Minuman', 10000),
('M4', 'Jeruk Peras', 'Minuman', 10000),
('M7', 'Cilok', 'Makanan ', 5000),
('M8', 'Rendang Babi', 'Makanan ', 12000);
...
CREATE TABLE `tbpenjualan` (
  ...
  `tanggalpembelian` varchar(40) NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('869', 'Kaori Miyazono', '04', 2, 20000, '2020-12-07 11:13:14'),
('T1', 'Mitsuha', '03', 5, 49000, '2019-12-09 11:23:59'),
('T2', 'Kaori Miyazono', '07', 3, 34000, '2019-12-09 11:24:29'),
('T3', 'Mikasa', '10', 1, 34000, '2019-12-09 11:27:46'),
('T4', 'Udin Parudin', '04', 5, 60000, '2019-12-14 10:38:31');
